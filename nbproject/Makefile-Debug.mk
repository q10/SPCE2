...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/spce2

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/spce2: ${OBJECTFILES}
...
${OBJECTDIR}/src/umbrella_spce_hamiltonian.o: src/umbrella_spce_hamiltonian.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/umbrella_spce_hamiltonian.o src/umbrella_spce_hamiltonian.cpp
...
${OBJECTDIR}/src/spce_hamiltonian.o: src/spce_hamiltonian.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/spce_hamiltonian.o src/spce_hamiltonian.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/spce2
