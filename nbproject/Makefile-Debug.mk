...
${OBJECTDIR}/src/sampler.o: src/sampler.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sampler.o src/sampler.cpp
...
${OBJECTDIR}/src/radial_dist.o: src/radial_dist.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/radial_dist.o src/radial_dist.cpp
