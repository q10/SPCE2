...
EWALD_NZ(sys.EWALD_NZ), TEMPERATURE(sys.TEMPERATURE), BETA(sys.BETA),
TARGET_WATER_DENSITY(sys.TARGET_WATER_DENSITY), BOX_LENGTH(sys.BOX_LENGTH),
HALF_BOX_LENGTH(sys.HALF_BOX_LENGTH), BOX_Z_LENGTH(sys.BOX_Z_LENGTH),
HALF_BOX_Z_LENGTH(sys.HALF_BOX_Z_LENGTH), BOX_VOLUME(sys.BOX_VOLUME),
WATERS(sys.WATERS), IONS(sys.IONS), TOTAL_ENERGY(sys.TOTAL_ENERGY) {
}
